...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        heading = Label(bg_img, text="Hệ thống xác định danh tính", font=("Times new roman", 21, "bold"), bg="white",
                        fg="#0000FF",
        ...
        Left_frame = LabelFrame(self.root, bd=2, bg="#36ADF1", relief=RIDGE, text="Màn hình nhận diện",
        ...
        self.Right_frame = LabelFrame(self.root, bd=6, bg="#36ADF1", relief=RIDGE, text="Danh Tính",
                                font=("times new roman", 12, "bold"))
        self.Right_frame.place(x=900, y=70, width=400, height=400)
        ...
        #id
        self.studentID_label = Label(self.studentID_atten_info, text="Mã người dùng:", font=("times new roman", 13, "bold"), bg="white")
        ...
        #tên hoc sinh
        self.studentname_label = Label(self.studentID_atten_info, text="Tên người dùng:", font=("times new roman", 13, "bold"),
                                     bg="white")
    ...
    def is_clicked(self):#nếu chưa bấm nút mở camera
        ...
        self.notify_label[
            'text'] = "Vui lòng mở Camera để xác nhận danh tính"
            ...
            def draw_boundray(img, classifier, scaleFactor, minNeighbors, color, text, clf):
                ...
                for (x, y, w, h) in features:
                    ...
                    if i is not None:  # Check if fetched student id is not None
                        i = i[0]
# Độ nhạy của việc quét qua khung nhận dạng bên phải.
                    if confidence > 75:
            ...
            def recognize(img, clf, faceCascade):
                ...
                # alpha = 1.5  # Hệ số tăng độ sáng (có thể điều chỉnh)
                # beta = 0  # Giá trị cộng thêm vào mỗi pixel (có thể điều chỉnh)
